...
All **185 skills** in one place. 93 are source-backed (verified with real toolchains); the rest are researched and honestly marked. For orientation by domain, see the domain READMEs under `skills/`; for triggers and rules, open each skill's `SKILL.md`.
